...
window.onload = function () {
    ...
    $('#record').click(function (e) {
        ...
        y_bar_canv.style.width = window.innerWidth * 0.082 + 'px';
        y_bar_canv.style.height = y_bar_canv.height + 'px';

        y_bar_canv.width = window.innerWidth * 0.078 * ratio;
        ...
        numX = 1000; //Math.round(canv.clientWidth * devicePixelRatio);
        color = new _webglPlot.ColorRGBA(0, 0, 0, 1);
        ...
        numX_spec = buflen;
        color_spec = new _webglPlot.ColorRGBA(0, 0, 0, 1);
...
function update() {
    ...
    // console.log(pitch);
    freq_text.innerHTML = "Your current pitch: "+get_pitch(freq);
